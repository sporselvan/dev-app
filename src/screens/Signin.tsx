        ...
        <div className="overlap">
          <div className="form">
            ...
            <div className="input">
              <div className="input-field">
                <div className="input-label">
                  <div
                    ...
                    style={{ backgroundColor: colorCodes.darkgrey }}
                  >
              ...
              <div className="input-field">
                <div className="input-label">
                  <div
                    className="input-master"
                    style={{ backgroundColor: "#2f334c" }}
                  >
                    <img className="img" src={lock} />
                    <div className="text-wrapper" style={{ color: "white" }}>
                      *********
                    </div>
            ...
            <div
              ...
              style={{ backgroundColor: colorCodes.secondary }}
              onClick={handleAddKeyword}
            >
              <div className="label-text-button" style={{ color: "white" }}>
                Sign In
              </div>
            </div>
          </div>
          ...
          <div className="frame">
            ...
            <div className="overlap-group">
              <div
                ...
                style={{ fontSize: 30, maxWidth: "250px" }}
              >
                Welcome to Gaming Universe
              </div>

              <img className="vector" src={crystalUp} />
              <img className="vector-2" src={crystalDown} />
            </div>
            <p className="from-ideas-to" style={{ color: "#9b87ff" }}>
              From Ideas to Realities.
              <br />
              Where Assets Make the Magic Happen
            </p>
          </div>
        </div>
      </div>
